// Vienna LaRose, silly sentences C
#include <stdio.h>
...
int main(void){
    ...
    //ask user for words (print statement with a question scanf to set to variable) (in C we need to tell the user that they can only type 1 word)
